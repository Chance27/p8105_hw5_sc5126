...
<img src="p8105_hw5_sc5126_files/figure-gfm/plot_power-1.png" width="90%" />
...
<img src="p8105_hw5_sc5126_files/figure-gfm/show_plot-1.png" width="90%" />
They are not equal. From the plots we can see that when the null
hypothesis is rejected and the true mean is between 0 and 3, the sample
average of estimated mean is higher than the true mean. In addition,
since the null hypothesis is rejected, it means that the sample mean
